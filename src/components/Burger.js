...
export default function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group
        onPointerOver={(e) => console.log("4")}
      >
        <mesh
          material={materials["Lower Bun"]}
          geometry={nodes.Lower_Bun.geometry}
          scale={[0.55, 0.1, 0.55]}
