...
import { buttonColor1, buttonColor2 } from "../../components/color/Color";
  ...
  return (
    ...
    >
      ...
      <ParallaxLayer
        ...
        // onClick={() => scroll(2)}
      >
        <MacbookLayer rotation={[0, rotY / 365.0, 0]} color={buttonColor2} />
      </ParallaxLayer>
      ...
      <ParallaxLayer offset={2} speed={1.0}>
        <KeyboardLayer rotation={[0, rotY / 365.0, 0]} color={buttonColor1} />
      </ParallaxLayer>
